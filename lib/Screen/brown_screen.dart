...
class BrownScreen extends StatefulWidget {
  const BrownScreen({super.key});

  @override
  State<BrownScreen> createState() => _BrownScreenState();
}

class _BrownScreenState extends State<BrownScreen> {
  @override
          ...
          children: [
            ...
            Stack(
              children:[
                ...
                SizedBox(
                    height: 400,
                    child: Image(image: AssetImage('assest/Haha.png'),height: 500,width: 550,)),
               ...
               Padding(
                 ...
                 child: Column(
                   ...
                   children: [
                     ...
                     Row(
                       children: [
                         Icon(Icons.star,color:Color(0xFF4B392A),size: 28,),
                         Icon(Icons.star,color:Color(0xFF4B392A),size: 28,),
                         Icon(Icons.star,color:Color(0xFF4B392A),size: 28,),
                         Icon(Icons.star,color:Color(0xFF4B392A),size: 28,),
                 ...
                 Padding(
                   ...
                   child: Text('30K',style: TextStyle(color: Colors.white,fontSize: 25,fontFamily: 'Anton'),),
                 ),
              ],
            ),
            Padding(
