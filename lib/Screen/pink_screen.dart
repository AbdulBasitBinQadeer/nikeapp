...
class PinkScreen extends StatefulWidget {
  ...
  @override
  State<PinkScreen> createState() => _PinkScreenState();
}

class _PinkScreenState extends State<PinkScreen> {
  @override
              ...
              children:[
                ...
                Positioned(
                  child: Padding(
                    ...
                    child: Container(
                        height: 400,
                        child: Image(image: AssetImage('assest/two.png'),fit: BoxFit.cover,)),
                  ),
                ),
